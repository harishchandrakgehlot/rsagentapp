...
export function AdminSidebar() {
  ...
  return (
    <>
      {/* Mobile Top Bar */}
      <div className="md:hidden flex items-center justify-between px-4 py-3 bg-[#161E42] text-white border-b border-slate-800 sticky top-0 z-40">
        <Link href="/admin" className="flex items-center space-x-2">
          <RoyalLogo variant="horizontal" theme="dark" height={28} />
        </Link>
        <button
