...
import { Search, ArrowRight, CheckCircle2, FileCheck, QrCode, Phone } from 'lucide-react';
        ...
        <div className="max-w-4xl mx-auto w-full text-center space-y-8">
          ...
          <div className="space-y-3">
            ...
            <p className="text-sm sm:text-base text-slate-300 max-w-xl mx-auto leading-relaxed">
              Track authenticated Royal Services tokens, validity periods, client records, and documentation in real time.
            </p>

            {/* Mode Switcher Tabs */}
            <div className="inline-flex p-1.5 rounded-2xl bg-[#0F1633] border border-[#2D3774] shadow-inner max-w-md mx-auto mt-2">
              <button
                type="button"
